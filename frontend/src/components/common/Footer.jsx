...
export default function Footer() {
    return (
        <footer className="border-t-2 border-deep-lavender-400 bg-butter-cream-100">
            <div className="max-w-7xl mx-auto px-6 lg:px-10 py-10">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    >
                        ...
                        <div>
                            <h2 className="text-xl font-bold">MOOC Sphere</h2>
                ...
                {/* Bottom */}
                <div className="mt-8 pt-6 border-t border-deep-lavender-200 text-center text-sm text-deep-lavender-500">
                    © {new Date().getFullYear()} MOOC Sphere. All rights reserved. Developed by Vishnu Cheruvakkara
                </div>
